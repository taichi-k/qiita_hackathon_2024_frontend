    ...
    return (
        <header className="text-gray-600 body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <Link href="/lobby" className="mr-5 hover:text-gray-900" id="generated-id-1726902635829-adsfs">
                    ロビー
                </Link>
                <Link href="/settings" className="mr-5 hover:text-gray-900" id="generated-id-1726902635829-adsfs">
                    設定
                </Link>
                <a href="/" className="mr-5 hover:text-gray-900" id="generated-id-1726902635829-9reuu9cas"></a>
                <span
